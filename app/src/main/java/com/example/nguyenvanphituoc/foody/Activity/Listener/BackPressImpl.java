package com.example.nguyenvanphituoc.foody.Activity.Listener;
...
public class BackPressImpl implements IOnBackPressListener {
    ...
    public boolean onBackPressed() {
        ...
        if (childCount == 0) {
            ...
            IOnBackPressListener childFragment = (IOnBackPressListener) childFragmentManager.getFragments().get(0);
